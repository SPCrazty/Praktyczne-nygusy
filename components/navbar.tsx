          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                  ...
                  <img
                    ...
                    src="https://ianbrownlee.files.wordpress.com/2019/12/cute-pink-elephant.jpg"
                    alt=""
                  />
                </a>
              </div>
              ...
              <a
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="
                     group bg-white rounded-md text-gray-500 inline-flex items-center text-xl font-medium hover:text-gray-900 focus:outline-none pb-8'
                    "
            ...
            */}
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="group bg-white rounded-md text-gray-500 inline-flex items-center text-lg font-medium hover:text-gray-900 focus:outline-none"
